...
function modifiedGramSchmidtQR( A_r, A_i, R_r, R_i ) {
  ...
  if( A_r.dimension !== 2 ) {
    throw new TypeError('ndarray-gram-schmidt-qr:: Dimension of A must be 2')
  }
  ...
  for( i=0; i<n; i++ ) {
    ...
    for( j=i+1; j<n; j++ ) {
      ...
      rij = blas.dotu( qi_r, qi_i, vj_r, vj_i )
      R_r.set( i, j, rij[0] )
      R_i.set( i, j, rij[1] )
...
module.exports = modifiedGramSchmidtQR
